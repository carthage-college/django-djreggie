...
#within this app, consentform, as well as settings to change how
#we view entries within 'consentform'

#'admin' - necessary to change view settings when viewing an 'consentform' object
#'messages' - necessary to change success/fail messages when performing an action to an 'consentform' object
from django.contrib import admin, messages
from djreggie.consentform.models import Form

#This is an 'action' a user can perform to a 'consentform' object
...
class Admin(admin.ModelAdmin):
    ...
    display = ('student_ID') #We will only see the following fields as columns in the admin page

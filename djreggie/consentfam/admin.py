...
from djreggie.consentfam.models import Form, ParentForm
...
class Admin(admin.ModelAdmin):
    list_display = ('Carthage_ID_Number', 'Full_Name_of_Student') #We will only see the following fields as columns in the admin page

...
from djreggie.consentfam.models import Form, ParentForm, Contact  #Include the models that goes with this form
...
class ModelForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['Carthage_ID_Number'].label = 'Carthage id'
        self.fields['Full_Name_of_Student'].label = 'Full name'
    ...
    class Meta:
        ...
        widgets = {
            'Carthage_ID_Number': forms.TextInput(attrs={'maxlength':7})
        }

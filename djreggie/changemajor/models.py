...
class ChangeModel(models.Model):
    ...
    #Majors
    #2015-10-30: Brigid requested that nursing not be included in the list of available majors
    getMajorSQL = '''
        SELECT
    ...
    major1 = models.CharField(max_length=200, choices=MAJOR_CHOICES, db_column='major1')
    minor1 = models.CharField(max_length=200, choices=MINOR_CHOICES, null=True, blank=True, db_column='minor1')
    major2 = models.CharField(max_length=200, choices=MAJOR_CHOICES, null=True, blank=True, db_column='major2')
    minor2 = models.CharField(max_length=200, choices=MINOR_CHOICES, null=True, blank=True, db_column='minor2')
    major3 = models.CharField(max_length=200, choices=MAJOR_CHOICES, null=True, blank=True, db_column='major3')
    minor3 = models.CharField(max_length=200, choices=MINOR_CHOICES, null=True, blank=True, db_column='minor3')
    ...
    def save(self):
        ...
        insertSQL = '''INSERT INTO cc_stg_changemajor (student_id, major1, major2, major3, minor1, minor2, minor3, advisor_id, datecreated)

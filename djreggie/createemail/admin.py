...
#within this app, createemail, as well as settings to change how
#we view entries within 'createemail'

#'admin' - necessary to change view settings when viewing an 'createemail' object
#'messages' - necessary to change success/fail messages when performing an action to an 'createemail' object
from django.contrib import admin, messages
from djreggie.createemail.models import EmailModel

#This is an 'action' a user can perform to a 'createemail' object
...
class EmailAdmin(admin.ModelAdmin):
    list_display = ('unique_id',) #We will only see the following fields as columns in the admin page
